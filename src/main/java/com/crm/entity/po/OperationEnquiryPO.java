...
public class OperationEnquiryPO {
    ...
    private String enquiryPerson;

    private String transportation;

    private BigDecimal tOperationPrice;
    ...
    public void setProuductCode(String prouductCode) {
        this.prouductCode = prouductCode == null ? null : prouductCode.trim();
    }
    ...
    public String getEnquiryPerson() {
        return enquiryPerson;
    }

    public void setEnquiryPerson(String enquiryPerson) {
        this.enquiryPerson = enquiryPerson == null ? null : enquiryPerson.trim();
    }
    ...
    public BigDecimal gettOperationPrice() {
        return tOperationPrice;
    }

    public void settOperationPrice(BigDecimal tOperationPrice) {
        this.tOperationPrice = tOperationPrice;
    }
}