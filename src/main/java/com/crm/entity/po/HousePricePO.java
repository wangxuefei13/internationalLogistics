...
public class HousePricePO implements Serializable {
    private String id;
    ...
    public String getHouseEnquiryId() {
        return houseEnquiryId;
    }

    public void setHouseEnquiryId(String houseEnquiryId) {
        this.houseEnquiryId = houseEnquiryId == null ? null : houseEnquiryId.trim();
    }
}