package com.internationalLogistics.entity.po;
...
public class OperationPricePO {
    ...
    private String quotedPricePerson;
    ...
    private String operationEnquiryId;
    ...
    public String getQuotedPricePerson() {
        return quotedPricePerson;
    }

    public void setQuotedPricePerson(String quotedPricePerson) {
        this.quotedPricePerson = quotedPricePerson == null ? null : quotedPricePerson.trim();
    }
    ...
    public void setQuotedPriceTime(Date quotedPriceTime) {
    ...
    public String getOperationEnquiryId() {
        return operationEnquiryId;
    }

    public void setOperationEnquiryId(String operationEnquiryId) {
        this.operationEnquiryId = operationEnquiryId == null ? null : operationEnquiryId.trim();
    }
}